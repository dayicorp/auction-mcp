...
![Tests](https://img.shields.io/badge/tests-105%20passed%20%7C%2020%20skipped-brightgreen)
...
- **125 项 pytest 测试** — 105 项离线通过 + 20 项 Live 默认跳过
...
└── tests/               # 125 项 pytest (含 PC browser / region boundary / resolve / validation / resilience / live)
```
